export const DEFAULT_COLORS = [
	...
	{ name: 'purple obsidian', hex: '#0D031B' },
	{ name: 'black blue', hex: '#040720' },
	{ name: 'night black', hex: '#0C090A' },
	{ name: 'obsidian black', hex: '#1C1C1C' },
	{ name: 'dark plum purple', hex: '#282224' },
	{ name: 'charcoal gray', hex: '#34282C' },
	{ name: 'oil black', hex: '#3B3131' },
	{ name: 'jet black', hex: '#343434' },
	{ name: 'stormy gray', hex: '#3A3B3C' },
	{ name: 'charcoal gray 2', hex: '#3C4142' },
	{ name: 'light black', hex: '#454545' },
	{ name: 'dark steampunk gray', hex: '#4D4D4F' },
	{ name: 'black cat', hex: '#413839' },
	{ name: 'iridium gray', hex: '#3D3C3A' },
	...
	{ name: 'sonic silver gray', hex: '#757575' },
	{ name: 'platinum gray', hex: '#797979' },
	{ name: 'granite gray', hex: '#837E7C' },
	{ name: 'gray', hex: '#808080' },
	{ name: 'battleship gray', hex: '#848482' },
	{ name: 'sheet metal gray', hex: '#888B90' },
	{ name: 'dark gainsboro gray', hex: '#8C8C8C' },
	{ name: 'gunmetal gray', hex: '#8D918D' },
	{ name: 'cold metal gray', hex: '#9B9A96' },
	{ name: 'stainless steel gray', hex: '#99A3A3' },
	{ name: 'darkgray', hex: '#A9A9A9' },
	{ name: 'chrome aluminum gray', hex: '#A8A9AD' },
	{ name: 'gray cloud', hex: '#B6B6B4' },
	{ name: 'metal gray', hex: '#B6B6B6' },
	{ name: 'silver gray', hex: '#C0C0C0' },
	{ name: 'steampunk gray', hex: '#C9C1C1' },
	{ name: 'pale silver gray', hex: '#C9C0BB' },
	{ name: 'gear steel gray', hex: '#C0C6C7' },
	{ name: 'gray goose', hex: '#D1D0CE' },
	{ name: 'platinum silver gray', hex: '#CECECE' },
	...
	{ name: 'platinum gray 2', hex: '#E5E4E2' },
	{ name: 'metallic silver gray', hex: '#BCC6CC' },
	{ name: 'blue gray', hex: '#98AFC7' },
	{ name: 'roman silver gray', hex: '#838996' },
	...
	{ name: 'midnight navy blue', hex: '#003366' },
	...
	{ name: 'water blue 2', hex: '#EBF4FA' },
	{ name: 'alice blue white', hex: '#F0F8FF' },
	{ name: 'ghost white', hex: '#F8F8FF' },
	{ name: 'azure white', hex: '#F0FFFF' },
	{ name: 'light cyan blue', hex: '#E0FFFF' },
	{ name: 'light slate blue', hex: '#CCFFFF' },
	{ name: 'electric blue', hex: '#9AFEFF' },
	{ name: 'tron blue', hex: '#7DFDFE' },
	{ name: 'blue zircon', hex: '#57FEFF' },
	{ name: 'cyan aqua blue', hex: '#00FFFF' },
	{ name: 'bright cyan blue', hex: '#0AFFFF' },
	{ name: 'neon cyan blue', hex: '#4BF0FC' },
	{ name: 'celeste blue', hex: '#50EBEC' },
	{ name: 'blue diamond', hex: '#4EE2EC' },
	{ name: 'bright turquoise blue', hex: '#16E2F5' },
	{ name: 'blue lagoon', hex: '#8EEBEC' },
	{ name: 'paleturquoise blue', hex: '#AFEEEE' },
	{ name: 'pale blue lily', hex: '#CFECEC' },
	{ name: 'light teal blue', hex: '#B3D9D9' },
	{ name: 'tiffany blue', hex: '#81D8D0' },
	{ name: 'blue hosta', hex: '#77BFC7' },
	{ name: 'cyan opaque blue', hex: '#92C7C7' },
	{ name: 'northern lights blue', hex: '#78C7C7' },
	{ name: 'blue green', hex: '#7BCCB5' },
	{ name: 'mediumaquamarine green', hex: '#66CDAA' },
	{ name: 'aqua seafoam green', hex: '#93E9BE' },
	{ name: 'magic mint green', hex: '#AAF0D1' },
	{ name: 'light aquamarine green', hex: '#93FFE8' },
	{ name: 'aquamarine green', hex: '#7FFFD4' },
	{ name: 'bright teal green', hex: '#01F9C6' },
	{ name: 'turquoise blue', hex: '#40E0D0' },
	{ name: 'mediumturquoise blue', hex: '#48D1CC' },
	{ name: 'deep turquoise blue', hex: '#48CCCD' },
	{ name: 'jellyfish blue', hex: '#46C7C7' },
	{ name: 'blue turquoise', hex: '#43C6DB' },
	{ name: 'darkturquoise blue', hex: '#00CED1' },
	{ name: 'macaw blue green', hex: '#43BFC7' },
	{ name: 'lightseagreen', hex: '#20B2AA' },
	{ name: 'seafoam green', hex: '#3EA99F' },
	{ name: 'cadetblue', hex: '#5F9EA0' },
	{ name: 'deep sea green', hex: '#3B9C9C' },
	{ name: 'darkcyan green', hex: '#008B8B' },
	{ name: 'teal green', hex: '#00827F' },
	{ name: 'teal blue', hex: '#008080' },
	{ name: 'teal blue 2', hex: '#007C80' },
	{ name: 'medium teal green', hex: '#045F5F' },
	{ name: 'dark teal green', hex: '#045D5D' },
	{ name: 'deep teal green', hex: '#033E3E' },
	{ name: 'darkslategray', hex: '#25383C' },
	{ name: 'gunmetal gray 2', hex: '#2C3539' },
	{ name: 'blue moss green', hex: '#3C565B' },
	{ name: 'beetle green', hex: '#4C787E' },
	{ name: 'grayish turquoise blue', hex: '#5E7D7E' },
	{ name: 'greenish blue', hex: '#307D7E' },
	{ name: 'aquamarine stone blue', hex: '#348781' },
	...
	{ name: 'deep sea green 2', hex: '#306754' },
	...
	{ name: 'darkpurple', hex: '#8B008B' },
	{ name: 'mediumpurple', hex: '#9370DB' },
	{ name: 'bluepurple', hex: '#8A2BE2' },
